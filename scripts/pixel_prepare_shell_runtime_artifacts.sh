...
python3 - "$runtime_manifest_path" "$runtime_helper_content_fingerprint" "$timeline_config_json" "$counter_input_path" "$timeline_input_path" <<'PY'
import json
import sys
from datetime import datetime, timezone

manifest_path, content_fingerprint, timeline_config_json, counter_input_path, timeline_input_path = sys.argv[1:6]
manifest = {
